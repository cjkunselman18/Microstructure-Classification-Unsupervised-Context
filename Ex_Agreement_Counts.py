# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 16:59:24 2020
...
my_labels = st_svm.predict(ambig_feat)
lp_labels = lp_svm.predict(ambig_feat)
ckm_labels = ckm_svm.predict(ambig_feat)
tsvm_labels = tsvm_svm.predict(ambig_feat)
up_labels = updated_svm.predict(ambig_feat)
...
workbook = xlsxwriter.Workbook('Agreement Counts Example.xlsx')
